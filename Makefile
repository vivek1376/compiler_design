...
lexicalAnalyzer.o: lexicalAnalyzer.cpp lexicalAnalyzer.hpp token.hpp symbolTable.hpp helperFunctions.hpp inFile.hpp reporting.hpp
...
reporting.o: reporting.cpp reporting.hpp
	g++ -std=c++14 -o reporting.o -c reporting.cpp
